    ...
    render() {
        return (
            <Navbar className="navthegator border-bottom border-dark" collapseOnSelect expand="lg" variant="dark">
                <Navbar.Brand href="/"><img className="logo" alt="logo" src="http://nebula.wsimg.com/9ded58bed73da13862f641e537dfad90?AccessKeyId=C5BFFEBD8C6E0486FB19&disposition=0&alloworigin=1"/>PDBA</Navbar.Brand>
